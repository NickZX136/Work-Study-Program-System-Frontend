<script setup>
  ...
  const register = async()=>{
    ...
    let result = await administratorRegisterService(registerData.value);
    console.log(result);
    // if(result.code === '0'){
    //   //成功
  ...
  const login = async()=>{
    let result = await administratorLoginService(registerData.value);
      ...
      <el-col :span="6" :offset="3" class="form">
        ...
        <el-form ref="form" size="large" autocomplete="off" v-if="isRegister" :model="registerData" :rules="rules">
          ...
          <el-form-item prop="administratorId">
            <el-input :prefix-icon="User" placeholder="请输入用户名" v-model="registerData.administratorId"></el-input>
          </el-form-item>
        ...
        <el-form ref="form" size="large" autocomplete="off" v-else :model="registerData" :rules="rules">
          ...
          <el-form-item prop="administratorPassword">
            <el-input name="password" :prefix-icon="Lock" type="password" placeholder="请输入密码" v-model="registerData.administratorPassword"></el-input>
          </el-form-item>
          <el-form-item class="flex">
            <div class="flex">
